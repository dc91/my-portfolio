    ...
    <footer className="footer-section">
      <a id="phoneFoot" href="tel:076-70 39 336" className="footer-link">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800">
          ...
          <path class="phoneLines" d="M432.3,190.3c44.2,7.4,84.4,28.4,116.5,60.4s52.8,72.3,60.4,116.5c1.9,11.1,11.5,18.9,22.5,18.9
          ...
          <path class="phoneLines" d="M799.1,352.9c-15-88.1-56.6-168.3-120.4-232.2S534.7,15.4,446.5,0.3c-12.3-2.2-24,6.2-26.2,18.6
