...
function About() {
  return (
    <section id="about" className="about-section">
      <p>
        Hi, I'm Dilan, a passionate tech enthusiast with a creative twist.
        My journey has been anything but ordinary—I've spent 10 years honing my skills as a cook and chef,
        mastering the art of creativity and precision in the kitchen. This hands-on experience taught me
        the value of discipline, problem-solving, and delivering results under pressure.
        <br /><br />
        Alongside my culinary career, I've always been fascinated by computers and creative pursuits like
        music and drawing. With a background in physics and a bachelor's thesis in particle physics,
        I bring analytical thinking and a knack for data analysis into my work. Now, I combine my
